...
# MLFlow
######################################
output "tracking_server_id" {
  value       = try(aws_sagemaker_mlflow_tracking_server.playground_server[0].id, null)
  description = "Id of the Tracking Server in SageMaker Experiments"
}
